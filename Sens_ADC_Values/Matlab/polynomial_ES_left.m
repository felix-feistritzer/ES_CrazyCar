...
adcOutput_front = [4095 3630 2980 2520 1960 1600 1350 1180 1060 970 890 840,...
    750 700 610 560 525 470]./lut_factor;                         % MEASURED ADC Values of your measured distances

relatedDistance_mm_front = [2.5 5 7.5 10 15 20 25 30 35 40 45 50 55 60 65 70 75 80] * 10; % HERE you could store your measured distance values


[p_front,s_front] = polyfit(adcOutput_front, relatedDistance_mm_front, 7);          % Fits a polynom of order-n to your input values 
