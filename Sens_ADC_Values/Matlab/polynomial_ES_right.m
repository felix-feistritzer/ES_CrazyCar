...
adcOutput_front = [4095 4095 3525 2865 2445 1885 1570 1315 1175 1040 955 870 815,...
    755 700 675 555 525 500]./lut_factor;                         % MEASURED ADC Values of your measured distances

relatedDistance_mm_front = [0 2.5 5 7.5 10 15 20 25 30 35 40 45 50 55 60 65 70 75 80] * 10; % HERE you could store your measured distance values


[p_front,s_front] = polyfit(adcOutput_front, relatedDistance_mm_front, 6);          % Fits a polynom of order-n to your input values 
