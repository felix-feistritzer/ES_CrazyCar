...
//***********************************
    ...
    // Port 6
    P6SEL |= DISTANCE_RIGHT;// Analog Input
    P6SEL |= DISTANCE_LEFT; // Analog Input
    P6SEL |= DISTANCE_FRONT;// Analog Input
    P6SEL |= VBAT_MEASURE;  // Analog Input
